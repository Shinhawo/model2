...
/*
 * localhost/model2/home.hta 요청을 처리하는 컨트롤러이다.
 */
public class HomeController implements Controller {
	...
	public String process(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("HomeConroller의 process(request, response) 실행됨.");
		
		// home.jsp에서 표현한 데이터를 요청객체에 저장하기
		// 요청객체에 message라는 이름으로 담았다.
...
//		request.setAttribute("items3", Map.of("name", "홍길동", "email", "hong@gmail.com"));
