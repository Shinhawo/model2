...
import controller.BoardDeatilController;
...
import controller.BoardUdateController;
...
public class FrontController extends HttpServlet {
	...
	@Override
	public void init() throws ServletException {  // 서블릿의 초기화를 담당
		...
		controllerMap.put("/board/detail.hta", new BoardDeatilController());
		controllerMap.put("/board/updateform.hta", new BoardUpdateFormController());
		controllerMap.put("/board/update.hta", new BoardUdateController());
	}
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. 요청 URO와 매핑된 Controller객체를 가져온다.
